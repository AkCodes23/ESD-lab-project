...
#define MPU6050_ADDR     (0x68 << 1)   // MPU6050 I2C 7-bit addr shifted left
...
int main(void) {
    ...
    // Wake MPU-6050 by writing 0 to PWR_MGMT_1 (0x6B)
    I2C1_Start();
    I2C1_Write(MPU6050_ADDR);  // Write mode
    ...
    while(1) {
        ...
        // Read high and low bytes for X accel
        I2C1_Start();
        ...
        // Validate reading (simple range check)
        ...
        // Step detection threshold crossing with previous value
